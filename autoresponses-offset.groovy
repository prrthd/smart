...
definition(
  name: "Autophrases with offset",
  namespace: "christianmadden",
  author: "Christian Madden + Jay",
...
def prefsPage()
{
  ...
  dynamicPage(name: "prefsPage")
  {
    ...
    {
      input "sunriseOffset", "enum", title: "Offset in minutes", required: false,
      options: ["-60", "-45", "-30", "-15", "-5", "5", "15", "30", "45", "60"]
    }
    section ("Sunset offset (optional)")
    {
      input "sunsetOffset", "enum", title: "Offset in minutes", required: false,
      options: ["-60", "-45", "-30", "-15", "-5", "5", "15", "30", "45", "60"]
    }
...
private initializeDaypart()
{
  ...
  def sun = getSunriseAndSunset(sunriseOffset: sunriseOffset, sunsetOffset: sunsetOffset)
